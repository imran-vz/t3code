...
export const SPEECH_STATE_CHANNEL = "desktop:speech-state";
export const SPEECH_PREVIEW_CHANNEL = "desktop:speech-preview";
export const SPEECH_GET_STATE_CHANNEL = "desktop:speech-get-state";
export const SPEECH_SELECT_MODEL_CHANNEL = "desktop:speech-select-model";
export const SPEECH_DOWNLOAD_MODEL_CHANNEL = "desktop:speech-download-model";
export const SPEECH_CANCEL_DOWNLOAD_CHANNEL = "desktop:speech-cancel-download";
...
export const SPEECH_PUSH_AUDIO_CHANNEL = "desktop:speech-push-audio";
